  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-gray-950">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        {/* Mobile top bar */}
        <header className="md:hidden sticky top-0 z-30 flex items-center gap-3 px-4 h-14 bg-white dark:bg-gray-900 border-b border-slate-200 dark:border-gray-800 shadow-sm dark:shadow-none">
          <button
            onClick={() => setOpen(true)}
            className="p-2 rounded-xl text-slate-500 dark:text-gray-400 hover:text-slate-700 dark:hover:text-gray-200 hover:bg-slate-100 dark:hover:bg-gray-800 transition-colors"
